...
codium --install-extension heaths.vscode-guid-1.7.0.vsix
codium --install-extension hediet.vscode-drawio
codium --install-extension henoc.svgeditor-2.9.0.vsix
...
codium --install-extension ms-azuretools.vscode-bicep-0.23.1.vsix
